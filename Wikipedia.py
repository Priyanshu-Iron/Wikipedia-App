...
im = PIL.Image.open(r'C:\Users\ps289\OneDrive\Python Project\pngwing.com.png')
im = im.resize((351, 263))
wp_img = ImageTk.PhotoImage(im)
panel4 = Label(windo, image=wp_img,bg = 'white')
panel4.pack()
panel4.place(x=20, y=100)

im1 = PIL.Image.open(r'C:\Users\ps289\Downloads\search-bar (1).png')
...
pred = tk.Label(windo, text="Wikipedia Explorer", width=30, height=2, fg="white",bg="black",
                font=('times', 25, ' bold '))
